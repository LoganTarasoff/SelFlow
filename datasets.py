...
class BasicDataset(object):
    ...
    def read_and_decode(self, filename_queue):
        ...
        img0_name = tf.strings.join([self.img_dir, '/', filename_queue[0]])
        print(img0_name)
        img1_name = tf.strings.join([self.img_dir, '/', filename_queue[1]])
        img2_name = tf.strings.join([self.img_dir, '/', filename_queue[2]])
    ...
    def create_one_shot_iterator(self, data_list, num_parallel_calls=4):
        ...
        iterator = tf.compat.v1.data.make_initializable_iterator(dataset)#dataset.make_initializable_iterator()
        return iterator
